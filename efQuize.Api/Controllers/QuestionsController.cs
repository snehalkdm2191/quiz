...
namespace efQuize.Controllers
{
    ...
    public class QuestionsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Questions>>> GetQuestions()
        {
            ...
            return await _context.Set<Questions>()
                .Include(e => e.Answer)
                .ToListAsync();
        }
        ...
        // GET: api/Questions/5
        [HttpGet("{id}")]
        public async Task<IEnumerable<Questions>> GetQuestions(int id)
        {
            //var questions = await _context.Questions.ToListAsync();
            var questions = await _context.Set<Questions>()
                .Include(e => e.Answer)
                .ToListAsync();
            
            var questionByGenre = questions.FindAll(data => data.GenreId == id);
